...
namespace Kirali.Environment.Procedural
{
    public static class PerlinNoise
    {
        ...
        public static double OctavePerlin(Kirali.MathR.Vector3 point, int octaves, double persistence)
        {
            return OctavePerlin(point.X, point.Y, point.Z, octaves, persistence);
        }
        ...
        public static double Perlin(MathR.Vector3 point)
        {
